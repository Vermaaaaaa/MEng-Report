...
\hline
\textbf{Method} & \textbf{Normalizes what?} & \textbf{Stats over}  & \textbf{Pros / Cons} \\
\hline
...
+ Batch-size independent -- sometimes weaker in CNNs \\
GroupNorm & Activations (channel groups) & Groups of channels within a sample &
+ Works with small batch; -- Number of groups need to be selected \\
