...
It measures the specific force along its orthogonal axes $a^x,a^y,a^z$. The main 
purpose of the accelerometer is to offer a gravity reference to the system such that
an accelerometer can provide drift-free inclination estimates \cite{sabatini_2011_estimating}.
...
objects \cite{detection}. Additionally, the accelerometer cannot detect rotations about the gravity
...
\label{sec:accelerrors}
Accelerometers suffer from very similar sources of errors to the gyroscope (\hyperref[sec:gyroerrors]{section 3.1.2}). Therefore, in this
...
to correct the orientation estimation through fusion, especially if gyroscopic drift is not addressed. 
