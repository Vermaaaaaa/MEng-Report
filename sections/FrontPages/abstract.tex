...
in IMU data, exploring if it outperforms a standard Kalman Filter (KF) without learned 
...
comes from simulations through MATLAB's Navigation Toolbox and from public datasets, 
